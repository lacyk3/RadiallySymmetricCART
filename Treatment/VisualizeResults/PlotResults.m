...
plot([0 84], [1.2 1.2],'k--') % progression
plot([0 84], [0.7 0.7],'k--') % partial response
plot([28 28], [0 2],'k') % week 4
plot([42 42], [0 2],'k') % week 6
plot([56 56], [0 2],'k') % week 8
plot([70 70], [0 2],'k') % week 10
